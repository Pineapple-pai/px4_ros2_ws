...
namespace ego_planner
{
  ...
  private:
    ...
    Eigen::Vector3d pending_goal_{Eigen::Vector3d::Zero()};
    Eigen::Vector3d last_manual_goal_{Eigen::Vector3d::Constant(std::numeric_limits<double>::quiet_NaN())};
    std::vector<Eigen::Vector3d> wps_;
    int current_wp_;

    bool flag_escape_emergency_;
    bool pending_manual_goal_{false};
